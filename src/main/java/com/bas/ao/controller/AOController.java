...
public class AOController {
    ...
    @GetMapping("/fetchebill/{workId}")
    public EBillDTO getWorkByEBillWorkID(@PathVariable String workId)
    {
    	return aoService.getEBillByWorkId(workId);
    }
...
//    }
    ...
    @GetMapping("/ebills/{workId}")
    public ResponseEntity<EBillDTO> getEbillByWorkId(@PathVariable String workId) {
        return ResponseEntity.ok(aoService.getEBillByWorkId(workId));
    }
